...
def chat_bot():
    knowledge_base: dict = load_knowledge_base(r'C:\Users\thant\OneDrive\Documents\Code\VS Codes Python\Bot\Knowledgebase\knowledge_base.json')
    random_responses = [
    ...
    while True:
        ...
        if best_match:
            ...
            if new_answer.lower() != 'skip':
                ...
                save_knowledge_base(r"C:\Users\thant\OneDrive\Documents\Code\VS Codes Python\Bot\Knowledgebase\knowledge_base.json", knowledge_base)
